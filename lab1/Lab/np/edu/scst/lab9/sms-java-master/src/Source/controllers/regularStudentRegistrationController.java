...
public class regularStudentRegistrationController implements Initializable {
    ...
    private ObservableList<String> titleList = FXCollections.observableArrayList(
            "Mr.", "Mrs.", "Dr.", "Rev.", "Prof.", "Ing.","Lawyer", "Barrister","Bishop","Master", "Justice", "Hon.", "Madam");
    ...
    public void validateSponsorPhoneNumberWhileTyping(){
        ...
        if (!valid){
            ...
            sponsorInputPhone =  code4/*countryCodeCombo4.getValue().getCode()*/ + sponsorInputPhone;
        }
    }
    ...
    private void createStudentEducationalBackground()throws IOException{
...
//            student_programme_error = false;
        ...
        !student_edu_error && !student_programme_error){

            Utils.showSnackBar(snackBarPane, "Saved Successfully", 2000);

            Task<Void> j_task = new Task<Void>(){
            ...
            new Thread(j_task).start();

            refreshPage();

           int res = Utils.confirmationDialog("Confirm",
                   "Do you want to assign this student a class?",
           ...
           if (res == Utils.YES){
               ...
               int response = Utils.confirmationDialog("Confirm",
                       "Do you want to assign this student a club?",
                       "Add student to club?" );
               if (response == Utils.YES){
                   applicationState.setUIState("club_management");
               }
//               else {
//                   Task<Void> m_task = new Task<Void>(){
//
//                       @Override
//                       protected Void call() throws IOException {
//                           createClubLessStudent();
//                           return null;
//                       }
//                   };
...
//               }
    ...
    private void createFreeRangeStudent()throws IOException{
        String sql= "insert into regular_students_without_class (`Student_ID`) values (?)";
...
//    private void createClubLessStudent()throws IOException{
//        String sql= "insert into regular_students_without_clubs (`Student_ID`) values (?)";
//
//        try (Connection connection = Utils.connectToDatabase();
//
//             PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
